			...
			<form method="POST" action="">
				...
				<table>
					<tr>
						...
						<td>
							<input type="text" placeholder="entrez votre pseudo" id="pseudo" name="pseudo" value="<?php if(isset($pseudo)) { echo $pseudo; } ?>" />
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="email" placeholder="entrez votre mail" id="mail" name="mail" value="<?php if(isset($mail)) { echo $mail; } ?>" />
						</td>
					</tr>
